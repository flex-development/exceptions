/**
 * @file Workspace Test Configuration - Mocha Global Fixtures
 * @module exceptions/tests/config/mochaGlobalFixtures
 ...
 *
 * [1]: https://github.com/storybookjs/testing-react#global-config
 *
